...
export const APISchemaContext = React.createContext<any>({
    openapi: '3.0.1',
    info: {
    ...
    tags: [
        {
            ...
            'x-components': ['Order', 'OrderBase'],
        },
        { name: 'Projects', description: 'Get projects and bundles' },
        {
        ...
        { name: 'Webhooks', description: 'A way to get notified about order state changes.' },
        {
    ...
    paths: {
        ...
        '/accounts/client': {
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        'application/json': {
                            schema: { $ref: '#/components/schemas/CreateClientAccountRequest' },
                        },
                    },
                },
                responses: {
            ...
            get: {
                ...
                responses: {
                    '200': {
                        ...
                        content: {
                            'application/json': {
                                schema: { $ref: '#/components/schemas/PaginatedClientAccounts' },
                            },
                        },
                    },
                    '400': { $ref: '#/components/responses/BadRequest' },
            ...
            post: {
                ...
                responses: {
                    '200': {
                        ...
                        content: {
                            'application/json': {
                                schema: { $ref: '#/components/schemas/AccountPair' },
                            },
                        },
                    },
                    '400': { $ref: '#/components/responses/BadRequest' },
                ...
                parameters: [
                    {
                        ...
                        schema: { type: 'string', format: 'date', example: '2019-01-01' },
                    },
                    {
                        name: 'end',
                        in: 'query',
                ...
                parameters: [
                    {
                        ...
                        schema: { type: 'string', example: '1vE213P96LbXNap56NAqVoM7knOedQg4' },
                    },
                ],
                responses: {
                    '200': {
                ...
                parameters: [
                    {
                        ...
                        schema: { type: 'string', example: 'alto-mayo' },
                    },
                ],
                responses: {
                    '200': {
        ...
        '/orders/by-mass': {
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        'application/json': {
                            schema: { $ref: '#/components/schemas/CreateOrderByQuantityRequest' },
                        },
                    },
                },
                responses: {
                    '200': {
                        ...
                        content: {
                            'application/json': {
                                schema: { $ref: '#/components/schemas/OrderByQuantity' },
                            },
                        },
                    },
                    '400': { $ref: '#/components/responses/BadRequest' },
        ...
        '/orders/by-value': {
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        'application/json': {
                            schema: { $ref: '#/components/schemas/CreateOrderByValueRequest' },
                        },
                    },
                },
                responses: {
                    '200': {
                        ...
                        content: {
                            'application/json': {
                                schema: { $ref: '#/components/schemas/OrderByValue' },
                            },
                        },
                    },
                    '400': { $ref: '#/components/responses/BadRequest' },
        ...
        '/orders/by-estimate': {
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        'application/json': {
                            schema: { $ref: '#/components/schemas/CreateOrderByEstimateRequest' },
                        },
                    },
                },
                responses: {
                    '200': {
                        ...
                        content: {
                            'application/json': {
                                schema: { $ref: '#/components/schemas/OrderByEstimate' },
                            },
                        },
                    },
                    '400': { $ref: '#/components/responses/BadRequest' },
                ...
                parameters: [
                    {
                        ...
                        schema: { type: 'string', example: 'sg5knd2' },
                    },
                ],
                responses: {
                    '200': {
        ...
        '/orders/by-mass/quote': {
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        'application/json': {
                            schema: { $ref: '#/components/schemas/OrderQuoteByQuantityRequest' },
                        },
                    },
                },
                responses: {
                    '200': {
                        ...
                        content: {
                            'application/json': {
                                schema: { $ref: '#/components/schemas/OrderQuoteByQuantity' },
                            },
                        },
                    },
                    '400': { $ref: '#/components/responses/BadRequest' },
        ...
        '/orders/by-value/quote': {
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        'application/json': {
                            schema: { $ref: '#/components/schemas/OrderQuoteByValueRequest' },
                        },
                    },
                },
                responses: {
                    '200': {
                        ...
                        content: {
                            'application/json': {
                                schema: { $ref: '#/components/schemas/OrderQuoteByValue' },
                            },
                        },
                    },
                    '400': { $ref: '#/components/responses/BadRequest' },
        ...
        '/bundle-selections': {
            get: {
                ...
                security: [{ BearerAuth: [] }],
                tags: ['Bundle selections'],
                responses: {
                    '200': {
                        description: 'OK',
                        content: {
                            'application/json': {
                                schema: { $ref: '#/components/schemas/BundleSelection' },
                            },
                        },
                    },
                    '401': { $ref: '#/components/responses/Unauthorized' },
            ...
            put: {
                ...
                requestBody: {
                    ...
                    content: {
                        'application/json': {
                            schema: { $ref: '#/components/schemas/BundleSelectionRequest' },
                        },
                    },
                },
                responses: {
        ...
        '/estimates/electricity': {
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        'application/json': {
                            schema: { $ref: '#/components/schemas/ElectricityEstimateRequest' },
                        },
                    },
                },
                responses: {
        ...
        '/estimates/flight': {
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        'application/json': {
                            schema: { $ref: '#/components/schemas/FlightEstimateRequest' },
                        },
                    },
                },
                responses: {
        ...
        '/estimates/shipping': {
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        'application/json': {
                            schema: { $ref: '#/components/schemas/ShippingEstimateRequest' },
                        },
                    },
                },
                responses: {
        ...
        '/estimates/individual': {
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        'application/json': {
                            schema: { $ref: '#/components/schemas/IndividualEstimateRequest' },
                        },
                    },
                },
                responses: {
        ...
        '/WebhookRequest': {
            post: {
                ...
                responses: {
                    '200': {
                        description:
                            'The events have been successfully handled. Any status code of the `2xx` format has the same behaviour. Any header or body are ignored by Lune.',
                    },
                },
            },
        },
    ...
    components: {
        securitySchemes: {
            BearerAuth: {
                ...
                scheme: 'bearer',
                description:
                    'Authorization Bearer API Key (see <a href="#section/Authentication">Authentication</a>)',
            },
            AccessToken: {
                type: 'apiKey',
                in: 'query',
        ...
        parameters: {
            LimitPagination: {
                ...
                in: 'query',
                required: false,
                description: 'Maximum number of resources to return, between 1 and 100.\n',
                schema: { type: 'string', pattern: '^\\d+$', default: '10', example: '50' },
            },
            AfterPagination: {
                name: 'after',
                in: 'query',
                ...
                schema: { type: 'string', example: '0vE213P96LbXNap56NAqVoM7knOedQg4' },
            },
        },
        responses: {
            ...
            NotFoundWithErrors: {
                ...
                content: {
                    'application/json': { schema: { $ref: '#/components/schemas/Errors' } },
                },
            },
            BadRequest: {
            ...
            Conflict: {
                description:
                    'The request could not be completed due to a conflict with the current state of the target resource or resources',
                content: {
                    'application/json': { schema: { $ref: '#/components/schemas/Errors' } },
                },
            },
        ...
        schemas: {
            ...
            Mass: {
                ...
                properties: {
                    amount: { type: 'string', pattern: '^[0-9]+(\\.[0-9]+)?$', example: '40.501' },
                    unit: { $ref: '#/components/schemas/MassUnit' },
                },
            },
            MassUnit: {
                type: 'string',
            ...
            Area: {
                ...
                properties: {
                    ...
                    unit: {
                        type: 'string',
                        enum: ['square_meters', 'square_feet'],
            ...
            OffsetValueSeriesItem: {
                ...
                required: ['date', 'value'],
                properties: {
                    date: { type: 'string', format: 'date', example: '2021-09-09' },
                    value: { type: 'string', example: '333.66', pattern: '^[0-9]+(\\.[0-9]+)?$' },
                },
            },
            ...
            OrderQuoteByQuantityRequest: {
                ...
                properties: {
                    mass: {
                        ...
                        allOf: [{ $ref: '#/components/schemas/Mass' }],
                    },
            ...
            BundleSelectionRequest: {
                ...
                items: { $ref: '#/components/schemas/BundlePercentageRequest' },
                example: [
                    { bundle_id: 'BmWxrvXo29eGqzA1qjANL5PwnkgaO8R3', percentage: 34 },
                    { bundle_id: 'VndoQ0PZjGMzvYOZGwqy6kbgN1eOJx9B', percentage: 66 },
                ],
            },
            ...
            BundleSelection: {
                ...
                items: { $ref: '#/components/schemas/BundlePercentage' },
                example: [
                    { bundle_id: 'BmWxrvXo29eGqzA1qjANL5PwnkgaO8R3', percentage: 34 },
                    { bundle_id: 'VndoQ0PZjGMzvYOZGwqy6kbgN1eOJx9B', percentage: 66 },
                ],
            ...
            OrderBase: {
                ...
                properties: {
                    ...
                    projects: {
                        ...
                        items: { $ref: '#/components/schemas/OrderProject' },
                        example: [
                            {
                                quantity: '600',
                                unit_price: '6.90',
            ...
            OrderQuoteBase: {
                ...
                properties: {
                    currency: { type: 'string', example: 'GBP', description: 'Currency code' },
                    estimated_quantity: {
                        type: 'string',
                        pattern: '^[0-9]+(\\.[0-9]+)?$',
                        example: '1040',
            ...
            ProjectSummary: {
                ...
                properties: {
                    ...
                    slug: { type: 'string', description: 'Project slug', example: 'alto-mayo' },
            ...
            CumulativeBundleAnalytics: {
                type: 'array',
                items: { $ref: '#/components/schemas/AnalyticsByBundle' },
            },
            AnalyticsByBundle: {
                type: 'object',
                required: ['bundle_id', 'bundle_name', 'timeseries'],
                properties: {
                    bundle_id: {
                        type: 'string',
                        description: "The bundle's unique identifier",
            ...
            QuantityAndValueTimeseries: {
                ...
                items: {
                    ...
                    example: [
                        { date: '2022-06-25', value: '13.20', quantity: '503.342' },
                        { date: '2022-06-26', value: '23.20', quantity: '1503.342' },
                        { date: '2022-06-27', value: '64.23', quantity: '4700.451' },
                    ],
                },
            },
            Analytics: {
                ...
                properties: {
                    ...
                    completed_offset_values: {
                        ...
                        items: { $ref: '#/components/schemas/OffsetValueSeriesItem' },
                    },
                    completed_offset_quantities: {
                        type: 'array',
                        description: 'An array of offest quantities grouped by completion date.',
                        items: { $ref: '#/components/schemas/OffsetQuantitySeriesItem' },
                    },
                    placed_offset_values: {
                        type: 'array',
            ...
            ShippingEstimateRequest: {
                ...
                required: ['shipment', 'route', 'method'],
                properties: {
            ...
            VariableFuelVariableLoadSeaShippingMethod: {
                ...
                properties: {
                    vessel_type: {
                        type: 'string',
                        enum: ['sea_bulk_carrier_medium', 'sea_bulk_carrier_large'],
                    },
                    fuel: { type: 'string', enum: ['HFO', 'MGO'] },
                    load: { type: 'string', enum: ['average', 'heavy'] },
                },
            },
            RoRoSeaShippingMethod: {
                ...
                required: ['vessel_type'],
                properties: {
                    vessel_type: { type: 'string', enum: ['sea_roro'] },
                    fuel: { type: 'string', enum: ['HFO', 'MGO'] },
                    load: {
                        type: 'string',
                        enum: ['freight_only', 'truck_and_trailer', 'trailer_only'],
                    },
                },
            },
            HugeOilTankerSeaShippingMethod: {
                ...
                required: ['vessel_type'],
                properties: {
                    vessel_type: { type: 'string', enum: ['sea_oil_tanker_huge'] },
                    fuel: { type: 'string', enum: ['HFO', 'MGO', 'LNG'] },
                },
            },
            ...
            AirportSourceDestination: {
                ...
                properties: {
                    source: { $ref: '#/components/schemas/AirportCode' },
                    destination: { $ref: '#/components/schemas/AirportCode' },
                },
            },
            AirportCode: {
                type: 'object',
            ...
            IATACode: {
                ...
                properties: {
                    code: {
                        ...
                        pattern: '^[A-Z]{3}$',
                        description:
                            'Airport IATA code. For a full list of options (https://openflights.org/data.html)',
                        example: 'OPO',
                    },
                },
            },
            ICAOCode: {
                ...
                properties: {
                    code: {
                        ...
                        pattern: '^[A-Z]{4}[A-Z]?$',
                        description:
                            'Airport ICAO code. For a full list of options (https://openflights.org/data.html)',
                        example: 'LPPR',
                    },
                },
            },
            ...
            Address: {
                type: 'object',
                required: ['street_line1', 'postcode', 'city', 'country_code'],
                properties: {
                    street_line1: {
                        type: 'string',
                    ...
                    city: { type: 'string', example: 'Ledville' },
                    country_code: {
                        type: 'string',
                        example: 'GBR',
            ...
            IndividualEstimateRequest: {
                ...
                properties: {
                    ...
                    average_car_distance_travelled: {
                        ...
                        example: { amount: '6600', unit: 'km' },
                        default: { amount: '8000', unit: 'km' },
                    },
                    short_flights: {
                        type: 'integer',
                    ...
                    diet: { $ref: '#/components/schemas/Diet', example: 'medium_meat_eater' },
                    monthly_grocery_expenses: {
                        $ref: '#/components/schemas/MonetaryAmount',
                        description:
                            'Food, supermarket, farmers market, fishmongers etc... expenses',
                        example: { amount: '1500', currency: 'EUR' },
                    },
                    monthly_restaurant_expenses: {
                        $ref: '#/components/schemas/MonetaryAmount',
                        description: 'Dining and take out expenses',
                        example: { amount: '300', currency: 'EUR' },
                    },
                    monthly_clothing_expenses: {
                        $ref: '#/components/schemas/MonetaryAmount',
                        description: 'Clothing expenses',
                        example: { amount: '400', currency: 'EUR' },
                    },
                    monthly_furniture_appliances_expenses: {
                        $ref: '#/components/schemas/MonetaryAmount',
            ...
            CompanyEstimateRequest: {
                ...
                properties: {
                    ...
                    company_cars: { type: 'integer', description: 'Company cars', minimum: 0 },
                    average_car_distance_travelled: {
                        $ref: '#/components/schemas/Distance',
                        description: 'Average yearly distance travelled per car',
                    },
                    ...
                    tech: {
                        type: 'object',
                        properties: {
                            on_premise: { $ref: '#/components/schemas/CompanyOnPremiseUse' },
                            cloud: { $ref: '#/components/schemas/CompanyCloudUse' },
                        },
                    },
                    bundle_selection: { $ref: '#/components/schemas/BundleSelectionRequest' },
                    quantity_trunc: {
            ...
            CompanyCloudUse: {
                ...
                required: ['cost', 'provider'],
                properties: {
                    cost: { $ref: '#/components/schemas/MonetaryAmount' },
            ...
            CompanyOnPremiseUse: {
                ...
                required: ['electricity_cost'],
                properties: { electricity_cost: { $ref: '#/components/schemas/MonetaryAmount' } },
            },
            CloudProvider: {
                type: 'string',
                description: 'The identifier of a cloud provider.',
                example: 'aws',
                enum: ['aws', 'gcp', 'azure', 'ovh', 'other'],
            },
                    ...
                    { $ref: '#/components/schemas/PaginatedBase' },
                    {
                        ...
                        properties: {
                            data: {
                                ...
                                items: { $ref: '#/components/schemas/ClientAccount' },
                            },
                        },
                    },
                ],
            ...
            AccountPair: {
                ...
                required: ['live', 'test'],
                properties: {
                    live: { $ref: '#/components/schemas/Account' },
                    test: { $ref: '#/components/schemas/Account' },
                },
            },
            Account: {
                description: 'Account used for your regular operations.',
                allOf: [{ $ref: '#/components/schemas/AccountBase' }],
                type: 'object',
                required: ['scope', 'sibling_id'],
                properties: {
                    scope: { type: 'string', enum: ['account'] },
                    sibling_id: {
                        type: 'string',
                        description:
            ...
            ClientAccount: {
                ...
                type: 'object',
                required: ['scope'],
                properties: { scope: { type: 'string', enum: ['client_account'] } },
            },
            AnyAccount: {
                type: 'object',
                oneOf: [
